...
if (isset($_POST['admin1'])) {  
    ...
    if ($sqlregistration = $connection->prepare("INSERT INTO admin1 (email, username, password) VALUES (?, ?, ?)")) {
...
<div class="wrapper">
    ...
    <form action="" method="post">
        ...
        <div class="input-box button">
            <input type="submit" name="admin1" value="registration">
        </div>
        <div class="text">
            <h3>Already have an account? <a href="admin_login.php">Login here</a></h3>
        </div>
    </form>
</div>
